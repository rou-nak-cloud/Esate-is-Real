...
const About = () => {
  return (
    ...
    className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden-x' id='about'>
        <motion.h1
        initial={{opacity:0,y:-100}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:0.9, delay:0.2, ease:"easeIn"}}
        className='text-2xl sm:text-4xl font-bold mb-2'>About 
